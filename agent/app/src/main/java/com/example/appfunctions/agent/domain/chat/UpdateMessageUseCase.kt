...
/** Use case to update message state. */
class UpdateMessageUseCase
    ...
    constructor(private val chatRepository: ChatRepository) {
        ...
        suspend operator fun invoke(
            ...
            params.status?.let { status -> chatRepository.updateMessageStatus(messageId, status) }
        }
    }

/** Parameters for updating a message. */
data class UpdateMessageParams(val status: MessageProcessingStatus? = null)
