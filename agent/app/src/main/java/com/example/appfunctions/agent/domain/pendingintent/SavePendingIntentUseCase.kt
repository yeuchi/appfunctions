...
/** Use case to cache a transient PendingIntent action interaction dynamically. */
class SavePendingIntentUseCase
    @Inject
    constructor(private val pendingIntentRepository: PendingIntentRepository) {
        operator fun invoke(
            ...
            pendingIntentRepository.savePendingIntent(pendingIntentId, pendingIntent)
        }
    }
